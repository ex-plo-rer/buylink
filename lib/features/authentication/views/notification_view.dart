            ...
            body: NestedScrollView(
                headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
                  return <Widget>[
                    new SliverAppBar(
                      elevation: 0,
                      title: Text('Notification', style: TextStyle(color: AppColors.grey1, fontSize: 24), ),
                      pinned: true,
                      floating: true,
      ...
      home: Scaffold(
          ...
          ListView(
            ...
            children: <Widget>[
              ...
              ListTile(title: Text("The Levi Jeans store is around your present location", style: TextStyle(fontSize: 12),),
            ...
            ListView(
                ...
                children: <Widget>[
                  GestureDetector(
                      ...
                      child:
                      ListTile(title: Text("Atinuke Stores", style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold),),
                          leading: CircleAvatar(
                            backgroundColor: AppColors.shade3,
                            child: const Text('DE'),
                            radius: 24,
                          ), subtitle: Text ("Good evening i wanted to ask if you... "),
                          trailing: Column (children: <Widget> [ SizedBox(height: 6), CircleAvatar(
                            backgroundColor: AppColors.shade3, child: const Text('1', style: TextStyle(fontSize: 12)),
                            radius: 10,
