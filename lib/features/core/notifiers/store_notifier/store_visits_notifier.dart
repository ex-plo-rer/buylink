...
class StoreVisitsNotifier extends BaseChangeNotifier {
  ...
  void onDropDownChanged({required String newValue, required int storeId}) {
    ...
    _reader(storeDashboardNotifierProvider)
        .fetchVisitAnalytics(storeId: storeId, week: week);
...
final storeVisitsNotifierProvider =
    ChangeNotifierProvider.autoDispose<StoreVisitsNotifier>(
        (ref) => StoreVisitsNotifier(ref.read));
