...
class ProductSearchedNotifier extends BaseChangeNotifier {
  ...
  ProductSearchedNotifier(this._reader);
...
final productSearchedNotifierProvider =
    ChangeNotifierProvider.autoDispose<ProductSearchedNotifier>(
        (ref) => ProductSearchedNotifier(ref.read));
