...
Center (child:
    ...
    decoration: BoxDecoration(shape: BoxShape.rectangle,
                      borderRadius: BorderRadius.circular(10), color: AppColors.light ),

                child:


              Text(_open ? "Adjust Pin" : "Search for Location", style:
      TextStyle(color: AppColors.grey, fontSize: 14, fontWeight: FontWeight.w500),),),
              ...
              //   decoration: BoxDecoration(shape: BoxShape.rectangle,
              //       borderRadius: BorderRadius.circular(10), color: AppColors.light ),
              //  child: Center (child:Text ("Adjust Pin", style:
              //  TextStyle(color: AppColors.grey1, fontSize: 14, fontWeight: FontWeight.w500),)),
              // ),
            ),
),
