            ...
            child: Padding (
                ...
                child: Column(children: <Widget>[
                  ...
                  Align(
                    ...
                    child:Text("User Prohibitions ", style: TextStyle(color: AppColors.grey1, fontSize: 14 , fontWeight: FontWeight.bold),),),
                  Spacing.smallHeight(),
                  Text("Users are prohibited from: leasing, selling, copying, sublicensing, transferring, or assigning any"
                  ...
                  Align(
                    alignment: Alignment.centerLeft,
                    child:Text("Age Restriction ", style: TextStyle(color: AppColors.grey1, fontSize: 14 , fontWeight: FontWeight.bold),),),
                  Spacing.smallHeight(),
                  Align(
                      alignment: Alignment.centerLeft,
                  ...
                  Align(
                      alignment: Alignment.centerLeft,
                      child:Text("Service Interruptions and Updates  ", style: TextStyle(color: AppColors.grey1, fontSize: 14 , fontWeight: FontWeight.bold),)),
                  Spacing.smallHeight(),

                  Text("Any website can suffer either scheduled interruptions (for maintenance and upgrades purposes) or unintended shutdowns "
                      "(for whatever reason)."
                  ...
                  Align(
                      alignment: Alignment.centerLeft,
                      child:Text("Survival", style: TextStyle(color: AppColors.grey1, fontSize: 14 , fontWeight: FontWeight.bold),)),
                  Spacing.smallHeight(),
                  Text ("This Agreement shall be effective as of the date the User accepts the terms herein or first accesses, "
                  ...
                  Spacing.smallHeight(),
                  Text("Users must ensure that all of the information it submits or transmits fully complies with the law. "
                  ...
                  Align(
                      alignment: Alignment.centerLeft,
                      child:Text("Amendments", style: TextStyle(color: AppColors.grey1, fontSize: 14 , fontWeight: FontWeight.bold),)),
                  Spacing.smallHeight(),
                  Text ("Please note that Buylink might make changes to its Terms of Use from time-to-time so you should "
